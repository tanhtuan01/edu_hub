...
@Controller
@RequestMapping(value = "/school-lecturer/{domain}/tai-lieu")
public class LecturerDocumentController {
	...
	public String documentPage(Model model, Authentication authentication, @PathVariable(name = "domain")String domain) {
		BASE_METHOD.FragmentLecturerSchool("document", model);
	...
	public String saveDocument(@PathVariable(name = "domain")String domain,
		...
		return "redirect:/school-lecturer/" + domain + "/tai-lieu?added";
	}
